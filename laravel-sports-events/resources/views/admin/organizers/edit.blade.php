<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ✏️ Edit Organizer - {{ $organizer->name }}
        </h2>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('admin.organizers.update', $organizer) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="address" rows="3"
                                      class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('address', $organizer->address) }}</textarea>
                        </div>
