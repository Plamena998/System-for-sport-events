            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if(auth()->user()->is_admin)
                        ...
                        <x-nav-link :href="route('admin.sport_types.index')" :active="request()->routeIs('admin.sport_types.*')" wire:navigate>
                            ⚽ {{ __('Sport Types') }}
                        </x-nav-link>
                        
                        <x-nav-link :href="route('admin.organizers.index')" :active="request()->routeIs('admin.organizers.*')" wire:navigate>
                            👥 {{ __('Organizers') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->is_admin)
                ...
                <x-responsive-nav-link :href="route('admin.sport_types.index')" :active="request()->routeIs('admin.sport_types.*')" wire:navigate>
                    ⚽ {{ __('Sport Types') }}
                </x-responsive-nav-link>
                
                <x-responsive-nav-link :href="route('admin.organizers.index')" :active="request()->routeIs('admin.organizers.*')" wire:navigate>
                    👥 {{ __('Organizers') }}
                </x-responsive-nav-link>
